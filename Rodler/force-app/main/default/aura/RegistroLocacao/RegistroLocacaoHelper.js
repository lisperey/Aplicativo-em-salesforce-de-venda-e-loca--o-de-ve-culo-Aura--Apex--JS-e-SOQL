({
    //Função para pegar os dados do apex
    retornarInformação: function(component, event, helper) {
        ...
        action.setCallback(this, function(response){
            ...
            for(var i = 0; i < resposta.length; i++){
                ...
                if(tabela.Cliente__r) tabela.Cliente = tabela.Cliente__r.Name;
                if(tabela.Veiculo__r) tabela.Preco_locacao = tabela.Veiculo__r.Preco_Locacao__c;
                if(tabela.Sede__r) tabela.Sede = tabela.Sede__r.Name;
