    ...
    retornarInformação: function(component, event, helper) {
        ...
        action.setCallback(this, function(response){
            ...
            for(var i = 0; i < resposta.length; i++){
                ...
                if(tabela.Cliente__r) tabela.ClienteName = tabela.Cliente__r.Name;
                if(tabela.Veiculo__r) tabela.Modelo = tabela.Veiculo__r.Modelo__c, tabela.Marca = tabela.Veiculo__r.Marca__c;
                if(tabela.Sede__r) tabela.SedeName = tabela.Sede__r.Name;
    ...
    deletarRegistro: function(component, event, helper) {
        ...
        action.setCallback(this, function(response){
            ...
            if(state == 'SUCCESS'){
                ...
                helper.showToast("Successo!", "Registro Deletado com sucesso.", "success");
